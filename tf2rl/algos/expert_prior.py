...
class ExpertPrior(OffPolicyAgent):
    def __init__(
        ...
        self.tau  =  tau                    # 5e-3
        self.auto_alpha  =  auto_alpha      # False
        self.epsilon  =  epsilon            # 0.5                   #

        if auto_alpha:                              # value_penalty，False
    ...
    def _setup_actor(self, state_shape, action_dim, lr, max_action = 1.0):
        ...
        self.actor  =  ExpertGuidedGaussianActor(state_shape, action_dim, max_action, self._expert_prior, self._uncertainty)        #  return actions, log_pis, entropy, std, exp_log_pis, kl
    ...
    def train(self, states, actions, next_states, rewards, dones, weights = None):
        ...
        td_errors, actor_loss, vf_loss, qf_loss, q_value, logp_min, logp_max, logp_mean, entropy_mean,\
         kl_mean, std_mean, std_max, std_min  =  \
    ...
    def _train_body(self, states, actions, next_states, rewards, dones, weights):
        with tf.device(self.device):
            ...
            dones  =  tf.squeeze(dones, axis = 1)                       # (32, 1)->(32,)
